...
```
cd existing_repo
git remote add origin https://gitlab.cs.st-andrews.ac.uk/cs5031-p2-group04/cs5031p2code.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.cs.st-andrews.ac.uk/cs5031-p2-group04/cs5031p2code/-/settings/integrations)
